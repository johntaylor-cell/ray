...
def should_encode_columnar(
    ...
    # reports (e.g. the ControllerBench's ~5-10) fall back to Python objects. Mixed
    # columnar/object sources still aggregate correctly at the controller (see decode).
    widest = max(
